...
Los nodo2s se añaden y se remueven por un solo extremo.
...
/*
void Push(pila *s, nodo2 e);
Descripción: Empilar (Introducir un nodo2 a la pila)
Recibe: int *s (Referencia a la pila "s" a operar), nodo2 e (Elemento a introducir en la pila)
Devuelve:
...
/*
void Pop(pila *s);
Descripción: Desempilar (Extraer un nodo2 de la pila)
Recibe: int *s (Referencia a la pila "s" a operar)
Devuelve: nodo2 (Elemento e extraido de la pila)
Observaciones: El usuario a creado una pila y s tiene la referencia a ella, s ya ha sido inicializada.
...
/*
nodo2 Top(pila *s);
Descripción: Tope (Obtener el "nodo2" del tope de la pila si extraerlo de la pila)
Recibe: int *s (Referencia a la pila "s" a operar)
Devuelve: nodo2 (Elemento del tope de la pila)
Observaciones: El usuario a creado una pila y s tiene la referencia a ella, s ya ha sido inicializada.
...
/*
int Size(pila *s);
Descripción: Tamaño de la pila (Obtener el número de nodo2s en la pila)
Recibe: int *s (Referencia a la pila "s" a operar)
Devuelve: int (Tamaño de la pila -1->Vacia, 1->1 nodo2, 2->2 nodo2s, ...)
Observaciones: El usuario a creado una pila y s tiene la referencia a ella, s ya ha sido inicializada.
*/
int Size(pila *s)
{
...
/*
void Destroy(pila *s);
Descripción: Elimina pila (Borra a todos los nodo2s en a la pila de memoria)
Recibe: int *s (Referencia a la pila "s" a operar)
Devuelve:
Observaciones: El usuario a creado una pila y s tiene la referencia a ella, s ya ha sido inicializada.
*/
